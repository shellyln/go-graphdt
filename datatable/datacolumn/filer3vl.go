...
func (p *DataColumn) GetFilter3VL(op FilterOp, v interface{}) (FilterGenFunc, error) {
	var err error
	...
	case Type_Nullable_Complex64:
		fn, err = disp.ComparableNullable3VL(
